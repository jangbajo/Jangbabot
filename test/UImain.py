...
wait_form_class = uic.loadUiType("./waitPro.ui")[0]
select_form_class = uic.loadUiType("./selectPro.ui")[0]
confirm_form_class = uic.loadUiType("./confirmPro.ui")[0]
find_form_class = uic.loadUiType("./findPro.ui")[0]
complete_form_class = uic.loadUiType("./completePro.ui")[0]
...
class waitWindowClass(QMainWindow, wait_form_class):
    ...
    def __init__(self):
        ...
        self.setupUI()
        self.setFixedSize(QSize(800, 480))  # 창크기 고정
...
class SelectWindowClass(QMainWindow, select_form_class):
    ...
    def setupUI(self):
        ...
        self.goodstableWidget.setColumnWidth(0, int(self.goodstableWidget.width() * 17 / 25))
        self.goodstableWidget.setColumnWidth(1, int(self.goodstableWidget.width() * 2 / 25))
        self.goodstableWidget.setColumnWidth(2, int(self.goodstableWidget.width() * 2 / 25))
...
class FindWindowClass(QMainWindow, find_form_class):
    ...
    def setupUI(self):
        ...
        pixmap = QPixmap('find2.png')
        self.backLabel.setPixmap(pixmap)
        self.goodstableWidget.setGeometry(310, 130, 475, 320)
